...
class _Module(nn.Module):
    ...
    def __call__(self, image, *, train=False):
        ...
        # Keep patch extraction and positional embeddings in float32 for numerical stability.
        ...
        # Cast back to the configured matmul dtype after the float32 embedding path.
