...
class Episode:
    ...
    def id(self) -> EpisodeID:
        episode_id = self.map_name + "_" + str(self.target_object.id) + "_" + str(self.description_id)
        return self.map_name, self.target_object.id, self.description_id, episode_id
