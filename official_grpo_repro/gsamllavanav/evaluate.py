...
def eval_goal_predictor(
    ...
    print(f'''
        final_pos_to_goal_dists.mean(): {final_pos_to_goal_dists.mean()}\n
        final_pred_to_goal_dists.mean(): {final_pred_to_goal_dists.mean()}\n
        (final_pos_to_goal_dists <= args.success_dist).mean(): {(final_pos_to_goal_dists <= args.success_dist).mean()}\n
        (final_pred_to_goal_dists <= args.success_dist).mean(): {(final_pred_to_goal_dists <= args.success_dist).mean()}\n
        oracle_pos_to_goal_dists.mean(): {oracle_pos_to_goal_dists.mean()}\n
        oracle_pred_to_goal_dists.mean(): {oracle_pred_to_goal_dists.mean()}\n
        (oracle_pos_to_goal_dists <= args.success_dist).mean(): {(oracle_pos_to_goal_dists <= args.success_dist).mean()}\n
        (oracle_pred_to_goal_dists <= args.success_dist).mean(): {(oracle_pred_to_goal_dists <= args.success_dist).mean()}\n
        mean_progress_mse, mean_final_progress_mse: {mean_progress_mse, mean_final_progress_mse}\n
        '''
    )
