...
class AlgoConfig(BaseConfig):
    ...
    # Reuse detached token log probabilities emitted by the rollout engine as
    # old-policy log probabilities, avoiding a duplicate actor forward pass.
    reuse_rollout_log_probs_as_old: bool = False
